...
class DistrictsDirectory(models.Model):
    ...
    state = models.ForeignKey('StatesDirectory', db_column='state_code', on_delete=models.CASCADE)
...
class BlocksDirectory(models.Model):
    ...
    district = models.ForeignKey('DistrictsDirectory', db_column='district_code', on_delete=models.CASCADE)
...
class VillagesDirectory(models.Model):
    ...
    block = models.ForeignKey('BlocksDirectory', db_column='block_code', on_delete=models.CASCADE)
